#ifndef FINITESTRAINANISOTROPICELASTICMATRIXSETTER_HPP
#define FINITESTRAINANISOTROPICELASTICMATRIXSETTER_HPP

#include "libgcm/rheology/setters/ISetter.hpp"

namespace gcm
{
        class FiniteStrainAnisotropicElasticMatrixSetter: public ISetter
        {
            public:
                /**
...
#endif /* FINITESTRAINANISOTROPICELASTICMATRIXSETTER_HPP */
