...
gcm::LineSecondOrderInterpolator::LineSecondOrderInterpolator()
{
...
void gcm::LineSecondOrderInterpolator::interpolate(CalcNode& node, CalcNode& nodeLeft, CalcNode& nodeCur, CalcNode& nodeRight)
{
